...
public class ArrayDemo {
	...
	/*
	 * int[][] scoreBoard1 = new int[2][9]; // 2D int array with 2 rows and 9
	 * columns
	 * 
	 * for (int team1 = 0; team1 < scoreBoard1.length; team1++) { for(int team2 = 0;
	 * team2 < scoreBoard1.length; team2++) { scoreBoard1[team1][team2] = team1 +
	 * team2; System.out.println(scoreBoard1); } //return total; }
	 * 
